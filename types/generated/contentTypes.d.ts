...
export interface ApiAboutUsAboutUs extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    domain: Schema.Attribute.Relation<'oneToOne', 'api::domain.domain'>;
    featured_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    founder_philosophy: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    our_values: Schema.Attribute.Blocks;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.metadata', true>;
    trust_banner: Schema.Attribute.Component<
...
export interface ApiBookingTermBookingTerm extends Struct.CollectionTypeSchema {
  collectionName: 'booking_terms';
  info: {
    displayName: 'Booking_Term';
    pluralName: 'booking-terms';
    singularName: 'booking-term';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking-term.booking-term'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'shared.metadata', false>;
...
export interface ApiContactInfoContactInfo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Maps_Link: Schema.Attribute.String;
    Office_Address: Schema.Attribute.Blocks;
    Phone: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    SEO: Schema.Attribute.Component<'shared.metadata', true>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiDomainDomain extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    booking_term: Schema.Attribute.Relation<
      'oneToOne',
      'api::booking-term.booking-term'
    >;
    brand_logo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    contact_info: Schema.Attribute.Relation<
      'oneToOne',
      'api::contact-info.contact-info'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiHomepageHomepage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Content for brand homepages';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    domain: Schema.Attribute.Relation<'oneToOne', 'api::domain.domain'>;
    featured_tours: Schema.Attribute.Relation<'manyToMany', 'api::tour.tour'>;
    featured_types: Schema.Attribute.Relation<'manyToMany', 'api::type.type'>;
    Founder_Philosophy: Schema.Attribute.Text;
    ...
    publishedAt: Schema.Attribute.DateTime;
    SEO: Schema.Attribute.Component<'shared.metadata', false>;
    TrustBanner: Schema.Attribute.Component<'trust-banner.trust-banner', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    DailyPlan: Schema.Attribute.DynamicZone<['tours.itinerary-day']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    homepages: Schema.Attribute.Relation<
      'manyToMany',
      'api::homepage.homepage'
    >;
    ...
    pricing_tiers: Schema.Attribute.Component<'price.pricing-tiers', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    what_to_bring: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::booking-term.booking-term': ApiBookingTermBookingTerm;
